...
selected_ep_devices = [ep_device for ep_device in all_ep_devices if ep_device.ep_name == lib_registration_name and ep_device.device.type == ort.OrtHardwareDeviceType.GPU]
